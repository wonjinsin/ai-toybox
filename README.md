...
| Folder | Description |
|--------|-------------|
| [`whisper/`](./whisper) | A local audio and video transcription CLI using `whisper.cpp` `large-v3` and Silero VAD. Generates text, SRT, or VTT subtitles without sending files to an external service. |
